...
#define PORT_CONTROLER   4545 		  // Port of controler
...
void main(void)
{
  ...
  while(1)
  {
    ...
    sprintf(buffer_to_controler, "Temperature Sensor(ACTIVE[%d])", count);
    count++;    
    ...
    sendto(multi_server_sock1, buffer_to_controler, sizeof(buffer), 0,
